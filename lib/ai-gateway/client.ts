...
export async function invokeManagedAI(baseUrl: string, secret: string, input: { organizationId: string; projectId: string; requestId: string; capability: 'text' | 'vision'; prompt: string; maxTokens: number; image?: number[] }) {
