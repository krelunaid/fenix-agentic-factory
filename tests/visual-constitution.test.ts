...
test('27 autopilot executes the sandbox scaffold and preview',()=>['writeFile','pnpm.*install','startProcess','sandbox\.preview'].forEach(pattern=>assert.match(autopilot,new RegExp(pattern))));
